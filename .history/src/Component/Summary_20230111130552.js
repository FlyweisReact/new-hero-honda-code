...
const Summary = () => {
  ...
  // console.log( moment(setStartDate).format('DD-MM-YYYY'))
  ...
  const filteredData =  (myNewStartingDate && myNewEndingDate) ? coupon.filter((i) => 
  i.Ad.includes(myNewStartingDate)
  )  :coupon
  ...
  return (
    <>
      ...
      <Container className="NewConT">
        ...
        <input
          type={"date"}
          onChange={(e) => moment(setStartDate(e.target.value)).format('DD-MM-YYYY')}
        />
