...
const Summary = () => {
  ...
  const filteredData = startDate.length <= 2 ? coupon : coupon.filter(checkFil) 

function checkFil (number) {
  return 
  number.Ad >= myNewStartingDate ?   number.Ad >= myNewStartingDate : 'No data Found' 
}
