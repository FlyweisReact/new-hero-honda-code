...
const Summary = () => {
  ...
  const coupon2 = [ {
    customer: "fdsfds",
    CouponCode: "JKDSfdsfsdf32",
    CustomerEmial: "fsdfsd@gmail.com",
    number: "123fdsfsd456720",
    Ad: "12/2/2004",
    Ed: "14/5/2005",
  },]
  ...
  const filteredData = startDate.length <= 2 ? coupon : coupon.filter((i)=> i.Ad >= myNewStartingDate && i.Ed <= myNewEndingDate) 
