...
function ResendCopuon(props) {
  return (
    ...
    >
      ...
      <div style={{display : 'flex' , justifyContent : 'center' , gap : '20px', marginTop : ''}}>
        <Button style={{width : '200px'}}>No</Button>
        <Button variant="outline-success"  style={{width : '200px'}}>Yes</Button>
      </div>
      </Modal.Body>
      <Modal.Footer>
      </Modal.Footer>
